...
public class QueryTest {
	...
	public void multipleFromTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
		SearchHits response = query(String.format("SELECT * FROM %s/phrase, %s/account LIMIT 2000", TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX));
	...
	public void selectFieldWithSpace() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		...
		SearchHits response = query(String.format("SELECT `test field` FROM %s/phrase_2", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
		for(SearchHit hit : hits) {
			Assert.assertEquals(expectedSource, hit.getSource().keySet());
		}
	...
	*/
	...
	public void equallityTest() throws SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("select * from %s/account where city = 'Nogal' LIMIT 1000", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
	...
	public void equallityTest_phrase() throws SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("SELECT * FROM %s/phrase WHERE phrase = 'quick fox here' LIMIT 1000", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
	...
	public void greaterThanTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		int someAge = 25;
		SearchHits response = query(String.format("SELECT * FROM %s WHERE age > %s LIMIT 1000", TestsConstants.TEST_INDEX, someAge));
		SearchHit[] hits = response.getHits();
		for(SearchHit hit : hits) {
	...
	public void orTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("SELECT * FROM %s/account WHERE gender='F' OR gender='M' LIMIT 1000", TestsConstants.TEST_INDEX));
	...
	public void andTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("SELECT * FROM %s WHERE age=32 AND gender='M' LIMIT 1000", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
		for(SearchHit hit : hits) {
	...
	public void likeTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("SELECT * FROM %s WHERE firstname LIKE 'amb%%' LIMIT 1000", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
	...
	public void notLikeTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("SELECT * FROM %s/account WHERE firstname NOT LIKE 'amb%%'", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
    ...
    public void regexpQueryTest() throws SqlParseException, SQLFeatureNotSupportedException {
        String query = String.format("select * from %s/dog where dog_name = REGEXP_QUERY('sn.*', 'ALL', 10000)", TestsConstants.TEST_INDEX);
	...
	public void doubleNotTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response1 = query(String.format("SELECT * FROM %s/account WHERE not gender like 'm' and not gender like 'f'", TestsConstants.TEST_INDEX));
		Assert.assertEquals(0, response1.getTotalHits());

		SearchHits response2 = query(String.format("SELECT * FROM %s/account WHERE not gender like 'm' and gender not like 'f'", TestsConstants.TEST_INDEX));
		Assert.assertEquals(0, response2.getTotalHits());

		SearchHits response3 = query(String.format("SELECT * FROM %s/account WHERE gender not like 'm' and gender not like 'f'", TestsConstants.TEST_INDEX));
		Assert.assertEquals(0, response3.getTotalHits());

		SearchHits response4 = query(String.format("SELECT * FROM %s/account WHERE gender like 'm' and not gender like 'f'", TestsConstants.TEST_INDEX));
		...
		SearchHits response5 = query(String.format("SELECT * FROM %s/account WHERE NOT (gender = 'm' OR gender = 'f')", TestsConstants.TEST_INDEX));
	...
	public void limitTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("SELECT * FROM %s LIMIT 30", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
	...
	public void betweenTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		int min = 27;
		int max = 30;
		SearchHits response = query(String.format("SELECT * FROM %s WHERE age BETWEEN %s AND %s LIMIT 1000", TestsConstants.TEST_INDEX, min, max));
		SearchHit[] hits = response.getHits();
		for(SearchHit hit : hits) {
			int age = (int) hit.getSource().get("age");
	...
	public void notBetweenTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		int min = 20;
		int max = 37;
		SearchHits response = query(String.format("SELECT * FROM %s WHERE age NOT BETWEEN %s AND %s LIMIT 1000", TestsConstants.TEST_INDEX, min, max));
		SearchHit[] hits = response.getHits();
		for(SearchHit hit : hits) {
	...
	public void inTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
		SearchHits response = query(String.format("SELECT age FROM %s/phrase WHERE age IN (20, 22) LIMIT 1000", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
		for(SearchHit hit : hits) {
			int age = (int) hit.getSource().get("age");
	...
	public void inTestWithStrings() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
		SearchHits response = query(String.format("SELECT phrase FROM %s/phrase WHERE phrase IN ('quick fox here', 'fox brown') LIMIT 1000", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
    ...
    public void inTermsTestWithIdentifiersTreatLikeStrings() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT name FROM %s/gotCharacters WHERE name.firstname = IN_TERMS(daenerys,eddard) LIMIT 1000", TestsConstants.TEST_INDEX));
        SearchHit[] hits = response.getHits();
        Assert.assertEquals(2, response.getTotalHits());
        for(SearchHit hit : hits) {
    ...
    public void inTermsTestWithNumbers() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT name FROM %s/gotCharacters WHERE name.ofHisName = IN_TERMS(4,2) LIMIT 1000", TestsConstants.TEST_INDEX));
        SearchHit[] hits = response.getHits();
        Assert.assertEquals(1, response.getTotalHits());
    ...
    public void termQueryWithNumber() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT name FROM %s/gotCharacters WHERE name.ofHisName = term(4) LIMIT 1000", TestsConstants.TEST_INDEX));
        SearchHit[] hits = response.getHits();
        Assert.assertEquals(1, response.getTotalHits());
        SearchHit hit = hits[0];
        String firstname =  ((Map<String,Object>) hit.getSource().get("name")).get("firstname").toString();
    ...
    public void termQueryWithStringIdentifier() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT name FROM %s/gotCharacters WHERE name.firstname = term(brandon) LIMIT 1000", TestsConstants.TEST_INDEX));
        SearchHit[] hits = response.getHits();
        Assert.assertEquals(1, response.getTotalHits());
        SearchHit hit = hits[0];
        String firstname =  ((Map<String,Object>) hit.getSource().get("name")).get("firstname").toString();
	...
	*/
	...
	public void notInTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("SELECT age FROM %s WHERE age NOT IN (20, 22) LIMIT 1000", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
		for(SearchHit hit : hits) {
			Map<String, Object> source = hit.getSource();
	...
	public void dateSearch() throws IOException, SqlParseException, SQLFeatureNotSupportedException, ParseException {
		...
		SearchHits response = query(String.format("SELECT insert_time FROM %s/online WHERE insert_time < '2014-08-18'", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
		for(SearchHit hit : hits) {
			Map<String, Object> source = hit.getSource();
    ...
    public void dateSearchBraces() throws IOException, SqlParseException, SQLFeatureNotSupportedException, ParseException {
        ...
        SearchHits response = query(String.format("SELECT odbc_time FROM %s/odbc WHERE odbc_time < {ts '2015-03-15 00:00:00.000'}", TestsConstants.TEST_INDEX));
        SearchHit[] hits = response.getHits();
        for(SearchHit hit : hits) {
            Map<String, Object> source = hit.getSource();
	...
	public void dateBetweenSearch() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		...
		SearchHits response = query(String.format("SELECT insert_time FROM %s/online WHERE insert_time BETWEEN '2014-08-18' AND '2014-08-21' LIMIT 3", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
		for(SearchHit hit : hits) {
			Map<String, Object> source = hit.getSource();
			DateTime insertTime = formatter.parseDateTime((String) source.get("insert_time"));
	...
	public void missFilterSearch() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
		SearchHits response = query(String.format("SELECT * FROM %s/phrase WHERE insert_time2 IS missing", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
	...
	public void notMissFilterSearch() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
		SearchHits response = query(String.format("SELECT * FROM %s/phrase WHERE insert_time2 IS NOT missing", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
	...
	public void complexConditionQuery() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
		...
		SearchHits response = query(String.format("SELECT * FROM %s/account WHERE (gender='m' AND (age> 25 OR account_number>5)) OR (gender='f' AND (age>30 OR account_number < 8))", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
	...
	public void complexNotConditionQuery() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		...
		SearchHits response = query(String.format("SELECT * FROM %s/account WHERE NOT (gender='m' AND NOT (age > 25 OR account_number > 5)) OR (NOT gender='f' AND NOT (age > 30 OR account_number < 8))", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
	...
	public void orderByAscTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("SELECT age FROM %s/account ORDER BY age ASC LIMIT 1000", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
	...
	public void orderByDescTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("SELECT age FROM %s/account ORDER BY age DESC LIMIT 1000", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
	...
	public void orderByAscFieldWithSpaceTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException {
		SearchHits response = query(String.format("SELECT * FROM %s/phrase_2 ORDER BY `test field` ASC LIMIT 1000", TestsConstants.TEST_INDEX));
		SearchHit[] hits = response.getHits();
    ...
    public void testMultipartWhere() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/account WHERE (firstname LIKE 'opal' OR firstname like 'rodriquez') AND (state like 'oh' OR state like 'hi')", TestsConstants.TEST_INDEX));
        Assert.assertEquals(2, response.getTotalHits());
    }

    @Test
    public void testMultipartWhere2() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/account where ((account_number > 200 and account_number < 300) or gender like 'm') and (state like 'hi' or address like 'avenue')", TestsConstants.TEST_INDEX));
    ...
    public void testMultipartWhere3() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/account where ((account_number > 25 and account_number < 75) and age >35 ) and (state like 'md' or (address like 'avenue' or address like 'street'))", TestsConstants.TEST_INDEX));
    ...
    public void filterPolygonTest() throws SQLFeatureNotSupportedException, SqlParseException, InterruptedException {
        SearchHits results = query(String.format("SELECT * FROM %s/location WHERE GEO_INTERSECTS(place,'POLYGON ((102 2, 103 2, 103 3, 102 3, 102 2))')", TestsConstants.TEST_INDEX));
    ...
    public void boundingBox() throws SQLFeatureNotSupportedException, SqlParseException, InterruptedException {
        SearchHits results = query(String.format("SELECT * FROM %s/location WHERE GEO_BOUNDING_BOX(center,100.0,1.0,101,0.0)", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1,results.getTotalHits());
        SearchHit result = results.getAt(0);
    ...
    public void geoDistance() throws SQLFeatureNotSupportedException, SqlParseException, InterruptedException {
        SearchHits results = query(String.format("SELECT * FROM %s/location WHERE GEO_DISTANCE(center,'1km',100.5,0.500001)", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1,results.getTotalHits());
        SearchHit result = results.getAt(0);
        Assert.assertEquals("square",result.getSource().get("description"));
    }
    ...
    public void geoDistanceRange() throws SQLFeatureNotSupportedException, SqlParseException, InterruptedException {
        SearchHits results = query(String.format("SELECT * FROM %s/location WHERE GEO_DISTANCE_RANGE(center,'1m','1km',100.5,0.50001)", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1,results.getTotalHits());
        SearchHit result = results.getAt(0);
        Assert.assertEquals("square",result.getSource().get("description"));
    }
    ...
    public void geoCell() throws SQLFeatureNotSupportedException, SqlParseException, InterruptedException {
        SearchHits results = query(String.format("SELECT * FROM %s/location WHERE GEO_CELL(center,100.5,0.50001,7)", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1,results.getTotalHits());
        SearchHit result = results.getAt(0);
        Assert.assertEquals("square",result.getSource().get("description"));
    }
    ...
    public void geoPolygon() throws SQLFeatureNotSupportedException, SqlParseException, InterruptedException {
        SearchHits results = query(String.format("SELECT * FROM %s/location WHERE GEO_POLYGON(center,100,0,100.5,2,101.0,0)", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1,results.getTotalHits());
        SearchHit result = results.getAt(0);
        Assert.assertEquals("square",result.getSource().get("description"));
    }
    ...
    public void escapedCharactersCheck() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/gotCharacters where nickname = 'Daenerys \"Stormborn\"' LIMIT 1000", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1, response.getTotalHits());
    }

    @Test
    public void complexObjectSearch() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/gotCharacters where name.firstname = 'Jaime' LIMIT 1000", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1, response.getTotalHits());
    }

    @Test
    public void complexObjectReutrnField() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT parents.father FROM %s/gotCharacters where name.firstname = 'Brandon' LIMIT 1000", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1, response.getTotalHits());
    ...
    public void queryWithATfieldOnWhere() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/gotCharacters where @wolf = 'Summer' LIMIT 1000", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1, response.getTotalHits());
        Map<String, Object> sourceAsMap = response.getHits()[0].sourceAsMap();
    ...
    public void notLikeTests() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        ...
        SearchHits response = query("SELECT name FROM " + TestsConstants.TEST_INDEX + "/gotCharacters where name.firstname not like '%d' LIMIT 1000");
    ...
    public void isNullTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query("SELECT name FROM " + TestsConstants.TEST_INDEX + "/gotCharacters where nickname IS NULL LIMIT 1000");
        Assert.assertEquals(3, response.getTotalHits());
    }

    @Test
    public void isNotNullTest() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query("SELECT name FROM " + TestsConstants.TEST_INDEX + "/gotCharacters where nickname IS NOT NULL LIMIT 1000");
        Assert.assertEquals(1, response.getTotalHits());
    }
    ...
    public void useScrollNoParams() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchResponse response = getSearchResponse(String.format("SELECT /*! USE_SCROLL*/ age,gender,firstname,balance FROM  %s/account LIMIT 2000", TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX));
    ...
    public void useScrollWithParams() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchResponse response = getSearchResponse(String.format("SELECT /*! USE_SCROLL(10,5000)*/ age,gender,firstname,balance FROM  %s/account ", TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX));
        Assert.assertNotNull(response.getScrollId());
        SearchHits hits = response.getHits();
        Assert.assertEquals(0,hits.getHits().length);
        Assert.assertEquals(1000,hits.getTotalHits());
    ...
    public void useScrollWithOrderByAndParams() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchResponse response = getSearchResponse(String.format("SELECT /*! USE_SCROLL(5,50000)*/ age,gender,firstname,balance FROM  %s/account order by age", TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX));
        Assert.assertNotNull(response.getScrollId());
        SearchHits hits = response.getHits();
    ...
    public void innerQueryTest() throws SqlParseException, SQLFeatureNotSupportedException {
        String query = String.format("select * from %s/dog where holdersName IN (select firstname from %s/account where firstname = 'Hattie')", TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX);
        SearchHit[] hits = query(query).getHits();
        Assert.assertEquals(1,hits.length);
        Map<String, Object> hitAsMap = hits[0].sourceAsMap();
        Assert.assertEquals("snoopy",hitAsMap.get("dog_name"));
    ...
    public void twoSubQueriesTest() throws SqlParseException, SQLFeatureNotSupportedException {
        String query = String.format("select * from %s/dog where holdersName IN (select firstname from %s/account where firstname = 'Hattie') and age IN (select name.ofHisName from %s/gotCharacters where name.firstname <> 'Daenerys') ", TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX);
        SearchHit[] hits = query(query).getHits();
        Assert.assertEquals(1,hits.length);
        Map<String, Object> hitAsMap = hits[0].sourceAsMap();
        Assert.assertEquals("snoopy",hitAsMap.get("dog_name"));
    ...
    public void inTermsSubQueryTest() throws SqlParseException, SQLFeatureNotSupportedException {
        String query = String.format("select * from %s/dog where age = IN_TERMS (select name.ofHisName from %s/gotCharacters where name.firstname <> 'Daenerys')", TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX);
        SearchHit[] hits = query(query).getHits();
        Assert.assertEquals(1,hits.length);
        Map<String, Object> hitAsMap = hits[0].sourceAsMap();
        Assert.assertEquals("snoopy",hitAsMap.get("dog_name"));
    ...
    public void idsQueryOneId() throws SqlParseException, SQLFeatureNotSupportedException {
        String query = String.format("select * from %s/dog where _id = IDS_QUERY(dog,1)", TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX);
        SearchHit[] hits = query(query).getHits();
        Assert.assertEquals(1,hits.length);
        Map<String, Object> hitAsMap = hits[0].sourceAsMap();
    ...
    public void idsQueryMultipleId() throws SqlParseException, SQLFeatureNotSupportedException {
        String query = String.format("select * from %s/dog where _id = IDS_QUERY(dog,1,2,3)", TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX);
        SearchHit[] hits = query(query).getHits();
        Assert.assertEquals(1,hits.length);
        Map<String, Object> hitAsMap = hits[0].sourceAsMap();
        Assert.assertEquals("rex",hitAsMap.get("dog_name"));
    ...
    public void idsQuerySubQueryIds() throws SqlParseException, SQLFeatureNotSupportedException {
        String query = String.format("select * from %s/dog where _id = IDS_QUERY(dog,(select name.ofHisName from %s/gotCharacters where name.firstname <> 'Daenerys'))", TestsConstants.TEST_INDEX, TestsConstants.TEST_INDEX);
        SearchHit[] hits = query(query).getHits();
        Assert.assertEquals(1,hits.length);
        Map<String, Object> hitAsMap = hits[0].sourceAsMap();
        Assert.assertEquals("rex",hitAsMap.get("dog_name"));
    ...
    public void nestedEqualsTestFieldNormalField() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/nestedType where nested(message.info)='b'", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1, response.getTotalHits());
    }

    @Test
    public void nestedEqualsTestFieldInsideArrays() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/nestedType where nested(message.info) = 'a'", TestsConstants.TEST_INDEX));
        Assert.assertEquals(2, response.getTotalHits());
    }
...
//    }
    ...
    public void complexNestedQueryBothOnSameObject() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/nestedType where nested('message',message.info = 'a' and message.author ='i' ) ", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1, response.getTotalHits());
    }

    @Test
    public void complexNestedQueryNotBothOnSameObject() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/nestedType where nested('message',message.info = 'a' and message.author ='h' ) ", TestsConstants.TEST_INDEX));
    ...
    public void nestedOnInTermsQuery() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/nestedType where nested(message.info) = IN_TERMS(a,b)", TestsConstants.TEST_INDEX));
        Assert.assertEquals(3, response.getTotalHits());
    }

    @Test
    public void childrenEqualsTestFieldNormalField() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/parentType where children(childrenType, info)='b'", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1, response.getTotalHits());
    }

    @Test
    public void childrenOnInQuery() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
    	SearchHits response = query(String.format("SELECT * FROM %s/parentType where children(childrenType, info) in ('a','b')", TestsConstants.TEST_INDEX));
    	Assert.assertEquals(2, response.getTotalHits());
    }

    @Test
    public void complexChildrenQueryBothOnSameObject() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/parentType where children(childrenType, info = 'a' and author ='e' ) ", TestsConstants.TEST_INDEX));
        Assert.assertEquals(1, response.getTotalHits());
    }

    @Test
    public void complexChildrenQueryNotBothOnSameObject() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/parentType where children(childrenType, info = 'a' and author ='j' ) ", TestsConstants.TEST_INDEX));
        Assert.assertEquals(0, response.getTotalHits());
    }

    @Test
    public void childrenOnInTermsQuery() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT * FROM %s/parentType where children(childrenType, info) = IN_TERMS(a,b)", TestsConstants.TEST_INDEX));
        Assert.assertEquals(2, response.getTotalHits());
    }

    @Test
    public void multipleIndicesOneNotExistWithHint() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT /*! IGNORE_UNAVAILABLE */ * FROM %s,%s ", TestsConstants.TEST_INDEX,"badindex"));
    ...
    public void multipleIndicesOneNotExistWithoutHint() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SearchHits response = query(String.format("SELECT  * FROM %s,%s ", TestsConstants.TEST_INDEX,"badindex"));
        Assert.assertTrue(response.getTotalHits() > 0);
    }

    @Test
    public void routingRequestOneRounting() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SqlElasticSearchRequestBuilder request = getRequestBuilder(String.format("SELECT /*! ROUTINGS(hey) */ * FROM %s/account ", TestsConstants.TEST_INDEX));
    ...
    public void routingRequestMultipleRountings() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        SqlElasticSearchRequestBuilder request = getRequestBuilder(String.format("SELECT /*! ROUTINGS(hey,bye) */ * FROM %s/account ", TestsConstants.TEST_INDEX));
        SearchRequestBuilder searchRequestBuilder = (SearchRequestBuilder) request.getBuilder();
...
//    }
    ...
    public void highlightPreTagsAndPostTags() throws IOException, SqlParseException, SQLFeatureNotSupportedException{
        String query = String.format("select /*! HIGHLIGHT(phrase,pre_tags : ['<b>'], post_tags : ['</b>']  ) */ " +
                ...
                "order by _score", TestsConstants.TEST_INDEX);

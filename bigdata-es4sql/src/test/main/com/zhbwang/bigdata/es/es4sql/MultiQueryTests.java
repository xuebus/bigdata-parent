...
import org.elasticsearch.plugin.zhbwang.ElasticHitsExecutor;
import org.elasticsearch.plugin.zhbwang.MultiRequestExecutorFactory;
...
public class MultiQueryTests {
    ...
    private SearchHit[] executeAndGetHits(String query) throws SqlParseException, SQLFeatureNotSupportedException, IOException {
        ...
        ElasticHitsExecutor executor  = MultiRequestExecutorFactory.createExecutor(searchDao.getClient(), (MultiQueryRequestBuilder) explain);
        executor.run();

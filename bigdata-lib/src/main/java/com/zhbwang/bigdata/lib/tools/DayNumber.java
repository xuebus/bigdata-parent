...
/**
 *** Performs convenience function on a "Day Number" Number of days since October
 * 15, 1582 (the first day of the Gregorian Calendar)
 **/

@SuppressWarnings("rawtypes")
public class DayNumber implements Comparable, Cloneable {
    ...
    /**
     *** Convert specified string to DayNumber. Valid formats are "yyyy/mm/dd" or
     * "yyyy-mm-dd".
     *** 
     * @param ymdStr
     *            The date to parse
    ...
    public static DayNumber parseDayNumber(String ymdStr) {
        ...
        if ((mm < 1) || (mm > 12)) {
            ...
            // invalid day
            return null;
        } else if (dd > DateTime.getDaysInMonth(null, mm, yy)) {
            // invalid day
            return null;
        }
     ...
     *** 
     * @param other
     *            The other DayNumber from which to copy
     **/
    ...
    public int getDayOfWeek() {
        return DateTime.getDayOfWeek(this.getYear(),
                                     this.getMonth(),
                                     this.getDayOfMonth());
    }
     ...
     **/
    public DateTime getDateTime(TimeZone tmz,
                                int hour24,
                                int minute,
                                int second) {
        DateTime.ParsedDateTime pdt = DateTime.getDateFromDayNumber(this.getDayNumber(),
                                                                    tmz);
    ...
    /**
     *** Returns true if the specified DayNumber is <b>equal-to</b> this DayNumber
     * instance
     *** 
     * @param obj
     *            the other DayNumber instance
     *** @return True if the specified DayNumber is <b>equal-to</b> this DayNumber
     *         instance
     **/
     ...
     * @param other
     *            The other DayNumber instance.
     *** @return &lt;0 of the other DayNumber instance is before this instance, 0
     *         if the other DayNumber instance is equal to this instance, and
     *         &gt;0 if the other DayNumber instance is after this instance.
     **/

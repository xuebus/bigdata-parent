...
public class ListTools
{
    ...
    *** @return The List instance containing the elements of the specified array
    **/
    public static <T> List<T> toList(T a[], List<T> list)
    {
        //return ListTools.toList(a, 0, -1, list);
        List<T> v = (list != null)? list : new Vector<T>();
    ...
    *** @return The List instance containing the elements of the specified array
    **/
    public static <T> List<T> toList(T a[], int ofs, int len, List<T> list)
    {
        List<T> v = (list != null)? list : new Vector<T>();
    ...
    *** @return The List instance containing the elements of the Enumeration
    **/
    public static <T> List<T> toList(Enumeration<T> e, List<T> list)
    {
        List<T> v = (list != null)? list : new Vector<T>();
    ...
    *** @return The List instance containing the elements of the Iterator
    **/
    public static <T> List<T> toList(Iterator<T> i, List<T> list)
    {
        List<T> v = (list != null)? list : new Vector<T>();
    ...
    *** @return The List instance containing the elements of the Set
    **/
    public static <T> List<T> toList(Set<T> s, List<T> list)
    {
    ...
    *** @return The List instance containing the elements of the StringTokenizer
    **/
    public static List<String> toList(StringTokenizer st, List<String> list)
    {
        List<String> v = (list != null)? list : new Vector<String>();
    ...
    *** @return The List instance containing the elements of the specified List
    **/
    public static <T> List<T> toList(List<T> ls, List<T> list)
    {
        List<T> v = (list != null)? list : new Vector<T>();

...
public class OrderedSet<K>
    implements Set<K>, List<K>, Cloneable
{
    ...
    **/
    ...
    {
        if (cl != null) {
            List<ChangeListener> listeners = this.getChangeListeners(true);
        ...
        if (listeners != null) {
            for (Iterator i = listeners.iterator(); i.hasNext();) {
                ...
                if (action == ENTRY_REMOVED) {
                	...
                	LogUtil.error("Unrecognized action: " + action);
                }
            }
        }
    }
    ...
    **/
    public boolean equals(Object other)
    {
        if (other instanceof OrderedSet) {
            ...
            List L1 = this.getBackingList();
            List L2 = os.getBackingList();

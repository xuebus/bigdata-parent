...
public class FileTools
{
        ...
        throws URISyntaxException
    {
        ...
        if (!url.getProtocol().equalsIgnoreCase("file")) {
            ...
            try {
                ...
                /*/
                return new File(decodeParameter(url.getPath()));
            	//*/
            }
        }
    }
    ...
    **/
        ...
        throws EOFException, IOException
    {
        ...
        if ((pattern != null) && (pattern.length > 0)) {
            hasPattern = true;
            plen = pattern.length;
            //LogUtil.info("Pattern: ["+plen+"] " + StringTools.toStringValue(pattern,'.'));
        }
        ...
        while (true) {
            ...
            if (cnt < 0) {
                ...
                if (progress && (maxLen > 0) && (length != maxLen)) {
                	LogUtil.error("Copy size mismatch: " + maxLen + " --> " + length);
                }
                break;
            } else
            if (cnt > 0) {
            ...
            if (progress) {
                ...
                if ((nowMS - lastMS) >= 1000L) {
                    ...
                    if (maxLen > 0) {
                        ...
                        LogUtil.info("Copying - %7d/%d bytes (%2.0f/%.0f sec, %2.0f%%)\r", 
                            length, maxLen, (elapseMS/1000.0), (totalMS/1000.0), (p*100.0));
                    } else {
                    	LogUtil.info("Copying - %7d bytes (%2.0f sec)\r", 
        ...
        if (progress) {
            ...
            LogUtil.info("Copied - %7d bytes (%.0f sec)                                     ", 
                length, (elapseMS/1000.0));
        }
    ...
    **/
    public static InputStream openInputFile(File file)
    {
        try {
            ...
            LogUtil.error("Unable to open file: " + file + " [" + ioe + "]");
            return null;
        }
    }
    ...
    public static void closeStream(InputStream in)
    {
        if (in != null) {
            try {
                ...
                //LogUtil.error("Unable to close stream: " + ioe);
            }
        }
    }
    ...
    **/
    public static void closeStream(OutputStream out)
    {
        ...
        if (out == System.out) {
            // ignore
            LogUtil.warn("Ignoring close on 'stdout'");
        } else
        if (out == System.err) {
            // ignore
            LogUtil.warn("Ignoring close on 'stderr'");
        } else {
            try {
                out.close();
            } catch (IOException ioe) {
    ...
    public static byte[] readFile(File file)
    {
        ...
        if (!file.exists()) {
            ...
            try {
                ...
                LogUtil.error("Unable to read file: " + file + " [" + ioe + "]");
            } finally {
...
//    {
//        if (msg == null) { msg = ""; }
//        LogUtil.info(msg + "    [String: default='" + dft + "'] ");
//        for (;;) {
//            Print.sysPrint("?");
...
//    {
//        if (msg == null) { msg = ""; }
//        LogUtil.info(msg + "    [Boolean: default='" + dft + "'] ");
//        for (;;) {
//            Print.sysPrint("?");
...
//    {
//        if (msg == null) { msg = ""; }
//        LogUtil.info(msg + "    [Long: default='" + dft + "'] ");
//        for (;;) {
//            Print.sysPrint("?");
//            String line = FileTools.readLine_stdin().trim();
//            if (line.equals("")) {
...
//    {
//        if (msg == null) { msg = ""; }
//        LogUtil.info(msg + "    [Double: default='" + dft + "'] ");
//        for (;;) {
//            Print.sysPrint("?");
//            String line = FileTools.readLine_stdin().trim();
//            if (line.equals("")) {
    ...
    **/
    public static List<String> findPatternInFile(File file, String pattern, boolean ignoreCase)
    {
        ...
        try {
            ...
            LogUtil.error("Error reading file: " + file + " [" + ioe + "]");
            return null;
        } finally {
    ...
    **/
    public static File[] getFiles(File dir, String fileGlob, boolean recursiveDecent)
    {
        ...
        if (fileGlob != null) {
            ...
            fileRegex.append("$");
            //LogUtil.info("File name regex: " + fileRegex);
            // create pattern
            try {
                pattern = Pattern.compile(fileRegex.toString());
            } catch (PatternSyntaxException pse) {
                LogUtil.error("Invalid fileName regular expression: " + fileRegex);
                return null;
            }
        }
